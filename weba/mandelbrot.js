...
var real__belongs_to_mandelbrot_set = asm["_belongs_to_mandelbrot_set"]; asm["_belongs_to_mandelbrot_set"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__belongs_to_mandelbrot_set.apply(null, arguments);
};
...
var _belongs_to_mandelbrot_set = Module["_belongs_to_mandelbrot_set"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_belongs_to_mandelbrot_set"].apply(null, arguments) };
